...
網址是直接交給 yt-dlp 處理的，程式本身**沒有任何網域判斷**，所以 yt-dlp 支援的站台（目前版本內建 1750 個 extractor）都能用。
...
| 項目 | 結果 |
| --- | --- |
| 最高畫質挑選 | 4K 來源挑到 AV1 3840x2160 + AAC 音軌 |
| 橫式下載合併 | 分軌下載 → FFmpeg 合併 → 檔名沿用標題 |
| 直式下載合併 | 1080x1920 AV1 + AAC，中文檔名正常 |
